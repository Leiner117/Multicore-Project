...
while op!="0":
    ...
    if op == "a": 
        ...
        print("Consulta B")
        cant_votantes.metodo_multicore(matriz,0,10)
        print ("Consulta C")
        cant_votantes.metodo_multicore(matriz,3,10)
        print ("Consulta D")
        cant_votantes.metodo_multicore(matriz,4,10)
        print ("Consulta E")
        cant_votantes.metodo_multicore(matriz,2,10)
        print ("Consulta F")
        cant_votantes.metodo_multicore(matriz,1,10)
        print ("Consulta G")
        cant_tipoCel.metodo_multicore(matriz)
        print ("Consulta H")
        anio = datetime.date.year
